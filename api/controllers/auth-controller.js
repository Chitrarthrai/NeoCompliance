...
async function login(req, res, next) {
    ...
    const { _id, name, username, email: dbEmail, password: hashPassword, role, status } = user;
...
async function refresh(req, res, next) {
    ...
    res.json({ success: true, message: 'Secure access has been granted', user, accessToken, refreshToken });
}
